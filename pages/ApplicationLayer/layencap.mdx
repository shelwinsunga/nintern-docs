...
Here, we're going to think about the concept of architectural laying. Let's begin with the human analogy of air travel.

If we break it down - we'll find that it's actually extremely complex. The steps involved would look something like:

1. You'd purchase a ticket
2. You'd check your baggage in
3. You approach the gates and load your luggage.
4. The plane takes runway and takes off.
5. Airplane routing..
