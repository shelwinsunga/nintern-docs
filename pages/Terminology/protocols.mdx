...
At the edge of the internet, we can see all kinds of devices: personal computers, laptops, cars, smartphones, datacenters - the list goes on. The number of devices that are connected to the internet
is in the order of *billions*. We call these devices **hosts** or end systems (because they're at the *edge* of the network). The array of devices we can connect to the internet are limitless: gaming consoles, mattresses; there's even a toaster
that is connected to the internet, takes the weather forecast, and burns that forecast onto a piece of bread!

<br />


![toast](../../public/wifitoast.jpg)
